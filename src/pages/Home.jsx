...
const Home = () => {
  ...
  return (
    <section id="homePageWrapper">
        <div id="heroSection" className= 'flex flex-col lg:flex-row md:flex-row sm:flex-row  justify-between pt-20 pl-20 pr-40 pb-2'>
            ...
            <div id="welcomeImage" className='w-0 h-0 lg:h-100 lg:w-auto sm:h-100 sm:w-auto md:h-100 md:w-auto lg:shrink-0 md:shrink-0 sm:shrink-0'>
                <img src={WelcomeImage} alt="Welcome"/>
            </div>
        </div>

        <div id="featureSection" className='flex flex-col lg:flex-row p-2 sm:flex-col md:flex-col '>
            <img src={FeatureImage} alt="Feature" className='w-full'/>
        ...
        <div id="getStartedSection" className='pb-2 flex justify-center'>
            ...
            <div className='pl-2 pt-60'>
                ...
                className=' border bg-lime-green text-3xl gap-2 m-2 p-4 rounded-lg flex text-san-marino font-playfair-display h-24 sm:h-20 md:h-20 lg:h-20 '>Get Started <img src={RightArrow} alt="right arrow"/> </button>
            </div>
        </div>
