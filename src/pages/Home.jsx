    ...
    <section id="homePageWrapper">
        ...
        <div id="getStartedSection" className='pb-2 flex justify-center'>
            ...
            <div className='pl-2 pt-60'>
                ...
                className=' border bg-lime-green text-3xl gap-2 m-2 p-4 rounded-lg flex text-san-marino font-playfair-display h-24 sm:h-20 '>Get Started <img src={RightArrow} alt="right arrow"/> </button>
            </div>
        </div>
